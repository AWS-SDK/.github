...
This is a browser-ready distribution of [`@aws-sdk/*`](https://github.com/aws/aws-sdk-js-v3) modules from AWS SDK for JavaScript v3. It is automatically built and published to a CDN, so developers can use AWS SDKs directly in the browser with zero bundling.
...
You can request any official [`@aws-sdk/client-* (or) @aws-sdk/lib-*`](https://github.com/aws/aws-sdk-js-v3/tree/main/clients) module from npm.
...
To request support for a new AWS SDK v3 browder package, [open an issue](https://github.com/aws-sdk/client-polly/issues).
